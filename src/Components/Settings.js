...
export default class Settings extends Component {
    ...
    handleFileSelect = (e) => {
        dialog.showOpenDialog({
            ...
            filters: [{ name: 'jpg', extensions: ['jpg'] }, { name: 'png', extensions: ['png'] }]
        })
            .then(res => {
                if (res.canceled) {
            ...
            <>
                <div style={{ textAlign: 'center' }}>
                    ...
                    <Grid container style={{ textAlign: 'center' }}>
                        ...
                        <Grid item xs={12} style={{ textAlign: 'center', fontFamily: 'Roboto' }}>
                            <h4 style={{ color: '#EEEEEE', padding: 0, fontStyle: 'italic', margin: 0 }}>{strings.description}</h4>
                        </Grid>
                        <Grid item xs={12} style={{ textAlign: 'center', fontFamily: 'Roboto', padding: '1rem' }}>
                            ...
                            <Button
                                style={{ marginLeft: '1rem', color: 'orange', borderColor: 'orange' }}
                                variant={'outlined'}
                        ...
                        <Grid item xs={12} style={{ textAlign: 'center', fontFamily: 'Roboto', padding: '1rem' }}>
                            <div style={
                                this.state.camEnabled ?
                                    { padding: '0.5rem', borderRadius: '10px', border: this.state.camEnabled ? '1px solid #333333' : '0px', display: 'inline-flex' } :
                                    null}>
                                {
                                    this.state.camEnabled ? <div id="camera" style={{ width: '25rem', height: '16rem', textAlign: 'center', margin: '0 auto' }}></div>
                                        : <></>
                                }
                                <Button
                                    variant={'contained'}
